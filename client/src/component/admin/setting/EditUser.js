    ...
    return (
        <Modal open={show} onClose={handleModalClose}>
            <Box className='bg-white w-4/5 mx-auto mt-40 border-none rounded-md'>
                ...
                <Box className='p-2'>
                    <Typography className='text-center !text-4xl color !font-medium'>Thêm tài khoản</Typography>
                    <Box className="flex p-12 justify-between">
                        <Box className="w-2/3 mt-10">
                            <Box className="flex mt-4">
                                ...
                                <FormControl sx={{ width: 1 / 5 }} className='!ml-4'>
                            ...
                            <Box className="flex mt-4">
                                <TextField id="outlined-basic" label="Số điện thoại" variant="outlined" type='number' className='KumbhSans' sx={{ width: 5 / 9 }} />
                                <TextField id="outlined-basic" label="Ngày sinh" variant="outlined" type='date' InputLabelProps={{ shrink: true }} className='KumbhSans !ml-4' sx={{ width: 3 / 7 }} />
                            </Box>
                            <Box className="flex mt-4 justify-between">
                                <TextField id="outlined-basic" label="Địa chỉ" variant="outlined" fullWidth className='KumbhSans' multiline rows={4} sx={{ width: 5 / 9 }} />
