import { Box, Button, FormControlLabel, IconButton, ImageList, Modal, Switch, TextField, Typography } from '@mui/material';
import React, { useState } from 'react'
import { MdClose } from 'react-icons/md';

const ModalNewCate = (props) => {
    ...
    return (
        <Modal open={show} onClose={handleModalClose}>
            <Box className='bg-white w-3/5 mx-auto mt-60 border-none rounded-md'>
                ...
                <Box className='p-2'>
                    <Typography className='text-center !text-4xl color !font-medium'>Thêm thể loại</Typography>
