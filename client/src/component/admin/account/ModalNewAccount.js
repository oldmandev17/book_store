                    ...
                    <Box className="flex p-12 justify-between">
                        <Box className="w-2/3 mt-10">
                            ...
                            <Box className="flex mt-4 justify-between">
                                ...
                                <Box sx={{ width: 3 / 7 }}>
                                    <TextField id="outlined-basic" label="Mật khẩu" variant="outlined" type='email' className='KumbhSans' fullWidth />
                                    <TextField id="outlined-basic" label="Nhập lại mật khẩu" variant="outlined" type='email' className='KumbhSans !mt-4' fullWidth />
                                </Box>
                            </Box>
                        </Box>
